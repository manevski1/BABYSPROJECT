    ...
    <Paper style={{ padding: '20px', borderRadius: '15px' }} elevation={6}>
      <div className={classes.card}>
        <div className={classes.section}>
          ...
          <Typography gutterBottom variant="body1" component="p">{post.shortDesc}</Typography>
          <Typography gutterBottom variant="body1" component="p">Best Served For: {post.category}</Typography>
